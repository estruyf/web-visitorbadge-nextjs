...
const navigation = {
  ...
  social: [
    {
      name: 'Instagram',
      href: 'https://instagram.com/eliostruyf',
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/eliostruyf',
      // eslint-disable-next-line react/display-name
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
